...
fn main() {
    ...
    unsafe {
        ...
        // let javascript = "print('Test Iñtërnâtiônàlizætiøn ┬─┬ノ( º _ ºノ) ');";
        let javascript = std::fs::read_to_string("/root/js-engine-benchmark/dist/run.js").unwrap();
...
unsafe extern "C" fn print(context: *mut JSContext, argc: u32, vp: *mut Value) -> bool { unsafe {
    ...
    unsafe extern "C" fn cb(message: *const core::ffi::c_char) { unsafe {
